...
const rules = [
  ...
  [/docs\/reports\/project-status\.md$/u, "[HOOK] Project status changed - [RULE] refresh the canonical AI Project Harness"],
  [/apps\/harness-dashboard\/(index\.html|dashboard-client\.mjs)$/u, "[HOOK] Canonical harness updated - [RULE] 대시보드 생성 완료 - [RULE] 비전: 사용자에게 결과 보고 및 http://127.0.0.1:4318/ 경로 안내"]
];
