...
| T1 | Audit current audio contract and lock the Phase 8 execution slice | ultron/audio-specialist | - | A2 | pending |
| T2 | Expand generated cue tuning contract and cue profile definitions | ultron/audio-specialist | T1 | A3 | pending |
| T3 | Improve runtime audio prioritization, loop switching, and anti-fatigue behavior | ultron/audio-specialist | T2 | A4 | pending |
| T4 | Expose audio debug and HUD-facing state for QA | ultron/audio-specialist | T3 | A5 | pending |
| T5 | Add deterministic unit coverage for audio routing and loop behavior | ultron/qa | T2, T3, T4 | A6 | pending |
| T6 | Expand browser coverage for weather and combat audio behavior | ultron/qa | T3, T4 | A7 | pending |
| T7 | Update playtest, tuning, and direction/status documents for Phase 8 | ultron/doc-writer | T1, T4, T6 | A8 | pending |
| T8 | Run verification gates, refresh execution report, and sync postflight | ultron/qa | T0-T7 | A9-A12 | pending |
