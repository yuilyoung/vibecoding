...
export function resolveDamageNumber(damage: number, isCritical: boolean): DamageNumberConfig {
  if (damage <= 0) {
  ...
  return { text: String(damage), color: "#ffffff", fontSize: 14, floatDistance: 28, durationMs: 600 };
}
