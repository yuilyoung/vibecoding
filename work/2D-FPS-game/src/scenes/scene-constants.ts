...
export const KENNEY_PLAYER_BLUE_KEY = "kenney-player-blue";
export const KENNEY_ENEMY_RED_KEY = "kenney-enemy-red";
export const KENNEY_FLOOR_TILE_KEY = "kenney-floor-tile";
export const KENNEY_PROP_CRATE_KEY = "kenney-prop-crate";
export const KENNEY_PROP_BARREL_KEY = "kenney-prop-barrel";
