...
- `game-specialist-phase7.md`
  ...
  - `docs/handoffs/current-handoff.json`과 `workspace/2D-FPS-game/docs/planning/phase7-wbs.md`, `phase7-tasks.json`을 먼저 읽고 시작
...
- `game-specialist-phase8.md`
  ...
  - `docs/handoffs/current-handoff.json`과 `workspace/2D-FPS-game/docs/planning/phase8-wbs.md`, `phase8-tasks.json`을 먼저 읽고 시작
